...
.then(data => {
    if (data.online == true) {
        ...
        {% else %}
        document.getElementById("serverStatus").innerHTML = `<p class="font-bold select-none"><span class="text-green-600">&#11044;</span>&emsp;服务器在线！&ensp;&middot;&ensp;${data.players.online}人在线游玩</p>`;
        ...
        {% else %}
        document.getElementById("serverStatus").innerHTML = `<p class="font-bold select-none"><span class="text-red-600">&#11044;</span>&emsp;抱歉！服务器下线...</p>`;
